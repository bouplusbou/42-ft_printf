...
void	test_empty()
{
   1.      ft_printf("");                                -> ""
   2. FAIL ft_printf("\n");                              -> "$\n"
   3. FAIL ft_printf("test");                            -> "test"
   4. FAIL ft_printf("test\n");                          -> "test$\n"
   5. FAIL ft_printf("1234");                            -> "1234"
   6. FAIL ft_printf("%%");                              -> "%"
   7. FAIL ft_printf("%5%");                             -> "    %"
   8. FAIL ft_printf("%-5%");                            -> "%    "
   9. FAIL ft_printf("%.0%");                            -> "%"
...
void	test_decimal()
{
	  97. FAIL ft_printf("%d", 1);                           -> "1"
  98. FAIL ft_printf("the %d", 1);                       -> "the 1"
  99. FAIL ft_printf("%d is one", 1);                    -> "1 is one"
 100. FAIL ft_printf("%d", -1);                          -> "-1"
 101. FAIL ft_printf("%d", 4242);                        -> "4242"
 102. FAIL ft_printf("%d", -4242);                       -> "-4242"
 103. FAIL ft_printf("%d", 2147483647);                  -> "2147483647"
 104. FAIL ft_printf("%d", 2147483648);                  -> "-2147483648"
 105. FAIL ft_printf("%d", -2147483648);                 -> "-2147483648"
 106. FAIL ft_printf("%d", -2147483649);                 -> "2147483647"
